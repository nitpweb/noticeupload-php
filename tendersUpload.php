...
define('GOOGLE_REDIRECT_URL', 'http://localhost/GoogleLogin/announcement.php');
...
$gClient->setApplicationName('Login to NITP');
...
if (isset($_GET['code'])) {
    ...
    $gClient->setRedirectUri("http://localhost/GoogleLogin/announcement.php");
    $_SESSION['token'] = $gClient->getAccessToken();
    header('Location: ' . filter_var("http://localhost/GoogleLogin/announcement.php", FILTER_SANITIZE_URL));
}
