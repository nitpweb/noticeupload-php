...
if (isset($_GET['code'])) {
    ...
    header('Location: ' . filter_var("http://localhost/GoogleLogin/event.php", FILTER_SANITIZE_URL));
}
...
?>
            ...
            <body>
                ...
                <script>
                    document.getElementById('eventin').value = "Events";
                </script>
